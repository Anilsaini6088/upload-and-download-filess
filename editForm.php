...
if($conn)
{
    ...
    $query2 = "SELECT id,title,mrp,offer_price,image FROM products WHERE id='$productSelectedId'";
...
<div class="container" style="margin-top:50px;width:auto;">
   ...
   <input style="margin-top:20px;"  value="<?=$image?>"  required type="file" name="file">
